...
/**
 * The Class GuestLectureseriesFriendlyURLMapper.
 */
public class GuestLectureseriesFriendlyURLMapper extends BaseFriendlyURLMapper {

	/** The Constant _MAPPING. */
	private static final String _MAPPING = "v";

	/** The Constant _PORTLET_ID. */
	private static final String _PORTLET_ID = "guestLectureseries_WAR_lecture2goguestspringportlet";
	...
	public void populateParams(String friendlyURLPath, Map<String, String[]> params,  Map<String, Object> arg2) {
		...
		try {
			addParam(params, "clipStartTime", s[3]);
			addParam(params, "clipEndTime", s[4]);
		} catch (Exception e) {}

...
/**
 * The Class CoordinatorLectureseriesInputValidator.
 */
public class CoordinatorLectureseriesInputValidator implements Validator {
	...
	public void validate(Object o, Errors errors) {
		...
		if (model.getFaculties().isEmpty()) {
			errors.rejectValue("faculties", "errors.required", requiredErrorMessage);
		}

		if (model.getProducers().isEmpty()) errors.rejectValue("producers", "errors.required", requiredErrorMessage);

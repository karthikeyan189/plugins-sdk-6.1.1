...
/**
 * The Class AdminApprovalLectureseriesController.
 */
public class AdminApprovalLectureseriesController extends AbstractController {
	...
	/*
	 * (non-Javadoc)
	 * @seeorg.springframework.web.portlet.mvc.AbstractController#
	 * handleActionRequestInternal(javax.portlet.ActionRequest,

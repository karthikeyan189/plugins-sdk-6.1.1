...
/**
 * The Class AdminLectureseriesManagementController.
 */
public class AdminLectureseriesManagementController extends AbstractController {
	...
	protected ModelAndView handleRenderRequestInternal(RenderRequest request, RenderResponse response) throws Exception {
		...
		if (lectureseriesId == 0) {
			...
			List<Facility> einListAll = ((FacilityDao)getDaoBeanFactory().getBean("facilityDao")).getAllSortedAsTree();

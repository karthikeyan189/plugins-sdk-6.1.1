...
import de.uhh.l2g.model.CoordinatorSegmentInputModel;
import de.uhh.l2g.util.HtmlManager;
import de.uhh.l2g.util.L2goPropsUtil;
import de.uhh.l2g.util.ProzessManager;

/**
 * The Class CoordinatorSegmentInputController.
 */
public class CoordinatorSegmentInputController extends SimpleFormController {
	...
	public void doSubmitAction(Object o) {
		CoordinatorSegmentInputModel model = (CoordinatorSegmentInputModel) o;
	 ...
	 * @param psm the psm
	 */
	private void create(CoordinatorSegmentInputModel psm) {
		CoordinatorSegmentInputModel model = psm;
	...
	protected Object formBackingObject(PortletRequest request) {
		CoordinatorSegmentInputModel model = new CoordinatorSegmentInputModel();

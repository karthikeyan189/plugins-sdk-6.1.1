...
/**
 * The Class StudentMetaDataValidator.
 */
public class StudentMetaDataValidator implements Validator {
	...
	public boolean supports(Class c) {
		return c.equals(StudentMetaDataModel.class);
	}
	...
	public void validate(Object o, Errors errors) {
		StudentMetaDataModel hw = (StudentMetaDataModel) o;
			if (hw.getAction().equals("create")) {
				...
				if (hw.getDescription().equals("")) errors.rejectValue("description", "error.invalid.description", "(!)");

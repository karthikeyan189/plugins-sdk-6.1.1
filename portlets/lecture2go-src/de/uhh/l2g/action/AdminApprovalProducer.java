...
/**
 * The Class AdminApprovalProducer.
 */
public class AdminApprovalProducer extends SimpleFormController implements InitializingBean, IFactory{
	...
	protected Object formBackingObject(PortletRequest request) throws Exception {
		...
		//set facilities list
		model.setFacilitiesList(((FacilityDao)getDaoBeanFactory().getBean("facilityDao")).getByLevel(1));

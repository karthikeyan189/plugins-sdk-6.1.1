...
/**
 * The Class GuestSearchFriendlyURLMapper.
 */
public class GuestSearchFriendlyURLMapper extends BaseFriendlyURLMapper {

	/** The Constant _MAPPING. */
	private static final String _MAPPING = "s";

	/** The Constant _PORTLET_ID. */
	private static final String _PORTLET_ID = "guestSearch_WAR_lecture2goguestspringportlet";

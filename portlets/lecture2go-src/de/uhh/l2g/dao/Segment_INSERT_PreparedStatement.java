...
/**
 * The Class Segment_INSERT_PreparedStatement.
 */
public class Segment_INSERT_PreparedStatement implements PreparedStatementCreator {
	
	/** The insert sql. */
	private String INSERT_SQL = "INSERT INTO segment (videoId, start, title, description, end, chapter, userId) VALUES(?,?,?,?,?,?,?)";
	...
	public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
		...
		ps.setInt(7,  new Integer(parameter[6]));

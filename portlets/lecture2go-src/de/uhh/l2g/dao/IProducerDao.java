...
public interface IProducerDao {
	 ...
	 */
	public void create(int userId, int hostId, int facilityId, int numberOfProductions, String idNum, String homeDir);
	 ...
	 * @return the by id
	 */
	public List<Producer> getById(long id);

...
<script type="text/javascript">
	...
	<div align="right">
		<a href='<portlet:renderURL portletMode="view"><portlet:param name="lectureseriesId" value="${model.lectureseriesId}"></portlet:param><portlet:param name="producerId" value="${model.producerId}"></portlet:param><portlet:param name="currentSeite" value="${model.currentSeite}"></portlet:param></portlet:renderURL>'>
			${gotooverview}
		</a>
	</div>
